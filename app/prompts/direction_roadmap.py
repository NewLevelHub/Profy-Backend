...
_GOAL_FOCUS: dict[str, str] = {
    ...
    "university": (
        ...
        "конкретной программе (дедлайны, экзамены, язык, портфолио, гранты, "
        "проходной балл — min_ent_threshold или admission_scores_2026, заметки по "
        "предметам — notes), и блок «ТВОЙ GAP-АНАЛИЗ ПО ЭТОЙ ПРОГРАММЕ» — что у "
