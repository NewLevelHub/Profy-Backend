...
короче по словам). НЕ пиши мысль в духе «это не окончательный выбор, а \
карта возможных направлений» и любые её вариации ни в каком предложении \
summary — рядом с summary всегда отдельно показывается disclaimer с ровно \
этой мыслью, повтор её твоими словами читается как дублирование одного и \
того же дважды. Третье (и далее) предложение должно добавлять НОВОЕ \
содержание — например практичный совет, на что обратить внимание дальше в \
отчёте, а не пересказ уже сказанного.
