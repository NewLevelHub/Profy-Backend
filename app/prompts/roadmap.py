...
Персонализация: опирайся на сильные стороны (strengths), интересы \
(interests_map), любимые и сложные предметы (subjects_*), что ученик ценит \
(values) и подобранные направления (directions). План должен вести к его цели.
