...
KK = {
    ...
    "flat_profile_artifact_note": (
        " Профиліңде хоббилерің туралы бөлек айттың — қазіргідей түрлі салалардың "
        "баллдары бір-біріне жақын болғанда, бұл хоббилер сенің бейімділіктерің "
    ...
    "interest_map_note_high": (
        "Айқын байқалады: {spheres}. Қалған салалар әлсіздеу көрінеді — бұл қалыпты жағдай."
    ),
    "interest_map_note_medium": (
        "Ең байқалатыны: {spheres} — күрт шыңдарсыз, қызығушылық біркелкі бөлінген."
    ),
    "interest_map_note_flat": (
        "Әзірге бір айқын жетекші саланы бөліп көрсету қиын — қызығушылық біркелкі "
        "бөлінген, бұл қалыпты: түрлі бағыттарға назар аударуға уақыт бар."
    ),
    "personality_note_high": (
        "Айқын байқалады: {traits} — бұл саған, бәлкім, ең табиғи түрде беріледі."
    ),
    "personality_note_low": "Дамытуға қызық тұстар бар: {traits}.",
    "personality_note_balanced": (
        "Мінез белгілері біркелкі байқалады, біреуі күрт басым емес — бұл қалыпты, "
        "мінезде міндетті түрде бір басты белгі болуы шарт емес."
    ),
    "career_why_match": "Сенде айқын байқалатынмен сәйкес келеді: {strengths}.",
    "career_why_skill_matched": " Дәл осы жерде мынау аса қажет болады: {skill}.",
    "career_why_skill_neutral": " Бұл салада мынау ерекше бағаланады: {skill}.",
}
