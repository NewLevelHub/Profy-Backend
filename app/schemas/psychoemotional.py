...
circle1 отправляется перед основной батареей тестов (`/start`), circle2 — в
конце всего прохождения, вместе с check-in (`/{run_id}/finish`). Метрики и
флаг достоверности наполняет движок PRO-307/PRO-308 отдельно."""
import uuid
