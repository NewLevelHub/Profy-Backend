...
- переводится только повествование (сводка, итог, карточки сильных сторон и
  ...
  **переносится** с проверяемой, а не пересчитывается по шкалам: коды
  ...
  составе и порядке, но из каталога на языке ученика; переписанное
  психологом описание направления, отредактированная мотивация и правка
  «Твой характер» — дословно, на языке, на котором их написали (перевести
  их нечем).
