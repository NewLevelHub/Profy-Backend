...
- гейт стоял не только на `/result`: все roadmap-ручки и уточнение
  направления тоже отвечали `409`, пока отчёт не опубликован (все эти ручки,
  как и goal-context с gap-анализом, удалены в PRO-425);
