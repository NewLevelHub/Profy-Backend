"""Example-response snapshots for the student v2 contract — a regular and
a flat-profile RIASEC response. Reuses the same schema
...
from tests.unit.test_result_v2_schema import _middle_fixture, _senior_fixture
