...
_JUNIOR_BIGFIVE_CONTENT: dict[tuple[str, int], _Content] = {
    ...
    ("A", 1): {  # A vs C
        "frame": "Друг просит одолжить вещь, а в комнате давно беспорядок, который пора убрать.",
        "option_a_text": "Одолжить другу вещь", "option_a_icon": "🤝",
        "option_b_text": "Убрать в комнате", "option_b_icon": "🧹",
    },
    ("C", 1): {  # C vs A (override target)
        "frame": "На проекте в команде можно довести свою часть до конца, или взять себе часть полегче.",
        "option_a_text": "Довести дело до конца", "option_a_icon": "✅",
        "option_b_text": "Взять полегче часть", "option_b_icon": "😏",
    },
    ("N", 3): {  # N vs O
        "frame": "После неудачи на контрольной можно погрустить дома, или попробовать сделать что-то новое, чтобы отвлечься.",
        "option_a_text": "Погрустить дома", "option_a_icon": "😢",
        "option_b_text": "Попробовать что-то новое", "option_b_icon": "🔀",
    },
    ("E", 3): {  # E vs C (override target)
        "frame": "В игре во дворе можно взять на себя главную роль, или ввязаться в шуточную потасовку с друзьями.",
        "option_a_text": "Взять на себя главное", "option_a_icon": "🙋",
        "option_b_text": "Затеять потасовку в шутку", "option_b_icon": "🤼",
    },
    ("O", 3): {  # O vs A (override target)
        "frame": "Увидев грустный фильм, можно сильно расчувствоваться, или сразу пойти доделывать домашку.",
        "option_a_text": "Сильно расчувствоваться", "option_a_icon": "💗",
        "option_b_text": "Доделывать домашку", "option_b_icon": "💼",
    },
    ("A", 3): {  # A vs N
        "frame": "Новенький в классе один на перемене.",
        "option_a_text": "Подойти и помочь освоиться", "option_a_icon": "🤗",
        "option_b_text": "Постесняться подойти", "option_b_icon": "😳",
    },
    ("C", 3): {  # C vs E
    ...
    ("N", 5): {  # N vs E
        "frame": "На дне рождения так весело, что тяжело остановиться и уйти вовремя.",
        "option_a_text": "Никак не успокоиться", "option_a_icon": "🛑",
        "option_b_text": "Веселиться и радоваться", "option_b_icon": "☀️",
    },
    ("E", 5): {  # E vs O
        "frame": "На каникулах можно поехать туда, где точно будет приключение, или послушать рассказы о жизни в других странах.",
        "option_a_text": "Поехать за приключением", "option_a_icon": "🎢",
        "option_b_text": "Послушать про другие страны", "option_b_icon": "🌍",
    },
    ("O", 5): {  # O vs A
        "frame": "Можно почитать сложную книгу, или пожалеть друга, которому сейчас нелегко.",
        "option_a_text": "Почитать сложную книгу", "option_a_icon": "📖",
        "option_b_text": "Пожалеть друга", "option_b_icon": "💔",
    },
    ("A", 5): {  # A vs C
        "frame": "На соревновании можно сказать всем, что ты точно лучше всех, или второпях выбрать первое, что попадётся.",
        "option_a_text": "Сказать, что ты лучше всех", "option_a_icon": "😤",
        "option_b_text": "Схватиться за всё не подумав", "option_b_icon": "🌪️",
    },
    ("C", 5): {  # C vs N
        "frame": "Внезапно поменялись планы на день.",
        "option_a_text": "Составить новый план", "option_a_icon": "🗺️",
        "option_b_text": "Растеряться и запаниковать", "option_b_icon": "😱",
    },
}
...
_MIDDLE_RIASEC_CONTENT: dict[tuple[str, int], _Content] = {
    # R vs S
    ("R", 1): {
        "frame": "Вечером сломался велосипед соседа, а друг зовёт погулять и поговорить о своих проблемах. Времени хватит на одно.",
        "option_a_text": "Чинить велосипед", "option_b_text": "Пойти поддержать друга",
    },
    ("R", 2): {
    ...
    ("R", 5): {
        "frame": "В классе сломалась техника, а новенькому нужно помочь освоиться — время до звонка есть только на одно.",
        "option_a_text": "Починить технику", "option_b_text": "Помочь новенькому",
    },
    ("R", 6): {
        "frame": "На даче можно помогать деду по хозяйству или поехать с семьёй в гости к родственникам.",
        "option_a_text": "Помогать по хозяйству", "option_b_text": "Поехать в гости",
    },
    # I vs E
    ("I", 1): {
    ...
    ("I", 3): {
        "frame": "Можно решить одну по-настоящему сложную задачу или стать капитаном команды на олимпиаде.",
    ...
    ("I", 6): {
        "frame": "В команде на конкурсе нужен либо тот, кто анализирует данные, либо тот, кто рискнёт предложить смелую идею прямо сейчас.",
    ...
    ("A", 3): {
        "frame": "На перемене можно дорисовать свой рисунок или разложить по папкам тетради, которые давно вперемешку.",
        "option_a_text": "Дорисовать рисунок", "option_b_text": "Разложить тетради",
    },
    ("A", 4): {
    ...
    ("A", 5): {
        "frame": "На кружке можно сочинить свою историю без правил или разложить по порядку карточки для готовой игры.",
        "option_a_text": "Сочинить историю", "option_b_text": "Разложить карточки",
    },
    ("A", 6): {
        "frame": "Перед контрольной можно порисовать то, что придумалось, или составить чёткий план подготовки по пунктам.",
        "option_a_text": "Порисовать", "option_b_text": "Составить план подготовки",
    },
}
...
_MIDDLE_BIGFIVE_CONTENT: dict[tuple[str, int], _Content] = {
    ...
    ("O", 1): {  # O vs N (override target)
        "frame": "На рисовании можно придумать что-то фантастическое или тщательно перепроверить рисунок на ошибки.",
        "option_a_text": "Придумать фантастическое", "option_b_text": "Всё перепроверить",
    },
    ("A", 1): {  # A vs C
    ...
    ("N", 3): {  # N vs O
        "frame": "Перед трудным экзаменом можно ещё раз перепроверить всё, что знаешь, или взглянуть на тему по-новому.",
        "option_a_text": "Перепроверить всё", "option_b_text": "Взглянуть по-новому",
    },
    ("E", 3): {  # E vs C (override target)
        "frame": "Учитель поручил группе важное задание.",
        "option_a_text": "Взять на себя роль главного", "option_b_text": "Взять самую сложную часть и сделать её лучше всех",
    },
    ("O", 3): {  # O vs A (override target)
        "frame": "На литературе можно пофантазировать, что было бы, если бы у истории был другой конец, или посочувствовать герою.",
        "option_a_text": "Придумать другой конец", "option_b_text": "Посочувствовать герою",
    },
    ("A", 3): {  # A vs N
    ...
    ("E", 5): {  # E vs O
        "frame": "На каникулах можно поехать туда, где точно будет весело и много новых знакомств, или остаться с книгой, которая заставляет думать по-новому.",
        "option_a_text": "Поехать, где весело", "option_b_text": "Остаться с книгой",
    },
    ("O", 5): {  # O vs A
        "frame": "Можно придумать необычную идею для проекта или взять то, что попроще, чтобы успеть помочь однокласснику.",
        "option_a_text": "Придумать необычную идею", "option_b_text": "Помочь однокласснику",
    },
    ("A", 5): {  # A vs C
