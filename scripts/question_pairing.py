...
def _merge_bilingual(
    ru_content: dict[tuple, _Content], kk_content: dict[tuple, dict[str, str]]
) -> dict[tuple, _Content]:
    """Fold a parallel `kk` content map into `ru_content`: each text field
    becomes `{"ru": <ru>, "kk": <kk>}`, icons pass through unchanged. Asserts
    exact key + field coverage so a `ru` edit can't ship without its `kk`."""
    assert set(ru_content) == set(kk_content), (
        f"kk content key drift: missing={sorted(set(ru_content) - set(kk_content))}, "
        f"stray={sorted(set(kk_content) - set(ru_content))}"
    )
    merged: dict[tuple, _Content] = {}
    for key, ru in ru_content.items():
        kk = kk_content[key]
        item: _Content = dict(ru)
        for field in _BILINGUAL_FIELDS:
            if ru.get(field) is not None:
                assert kk.get(field), f"{key}: kk.{field} missing"
                item[field] = {"ru": ru[field], "kk": kk[field]}
        merged[key] = item
    return merged
...
# kk (KZ-304) — LLM-primary, native review pending. Same tuple keys; only the
# text fields (icons stay in the `ru` dict above).
_KK_JUNIOR_RIASEC_CONTENT: dict[tuple, dict[str, str]] = {
    ("R", 1): {"frame": "Аулада самокат сынып қалды, ал досың қуаласпақ ойнауға шақырып тұр. Тек біреуіне ғана уақыт бар.",
               "option_a_text": "Самокатты жөндеу", "option_b_text": "Қуаласпақ ойнау"},
    ("R", 2): {"frame": "Еңбек сабағында құсқонақ жасауға, немесе бірдеңесі шықпай жатқан парталасыңа көмектесуге болады.",
               "option_a_text": "Құсқонақ жасау", "option_b_text": "Парталасқа көмектесу"},
    ("R", 3): {"frame": "Сабақтан кейін үйде ескі ойыншықты бөлшектеуге, немесе әлдеқашан шақырып жүрген досыңа қонаққа баруға болады.",
               "option_a_text": "Ойыншықты бөлшектеу", "option_b_text": "Қонаққа бару"},
    ("R", 4): {"frame": "Үзілісте шетте тыныш отыруға, немесе сыныпқа жаңа келген баламен танысуға баруға болады.",
               "option_a_text": "Шетте отыру", "option_b_text": "Жаңа баламен танысу"},
    ("R", 5): {"frame": "Үйде теледидардың пульті бұзылды, ал інің дәл қазір бірге ойнауды сұрап тұр.",
               "option_a_text": "Пультті жөндеу", "option_b_text": "Інімен ойнау"},
    ("R", 6): {"frame": "Дене шынықтыруда кедергі жолын құруға, немесе одан өтуден қорқатын балаға демеу беруге болады.",
               "option_a_text": "Кедергі жолын құру", "option_b_text": "Досқа демеу беру"},
    ("I", 1): {"frame": "Сабақта жұмбақты өзің шешуге, немесе балаларды жинап, ортақ ойын ойлап табуға болады.",
               "option_a_text": "Жұмбақ шешу", "option_b_text": "Бәрін ойынға жинау"},
    ("I", 2): {"frame": "Үйірмеде конструктордың қалай құрылғанын түсінуге, немесе не ойлап тапқаныңды бәріне көрсетуге болады.",
               "option_a_text": "Конструкторды түсіну", "option_b_text": "Бәріне көрсету"},
    ("I", 3): {"frame": "Ғылыми бұрышта тәжірибені өзің жасауға, немесе не шыққанын бүкіл сыныпқа айтуға болады.",
               "option_a_text": "Тәжірибе жасау", "option_b_text": "Сыныпқа айту"},
    ("I", 4): {"frame": "Үзілісте суреттегі не дұрыс еместігін байқауға, немесе бәріне жаңа ойын ойнауды ұсынуға болады.",
               "option_a_text": "Не дұрыс еместігін байқау", "option_b_text": "Жаңа ойын ұсыну"},
    ("I", 5): {"frame": "Сабақтан кейін күрделі әрі қызық нәрсе туралы оқуға, немесе аулада бір тәуекелді іске баруға болады.",
               "option_a_text": "Қызық нәрсе оқу", "option_b_text": "Тәуекелді сынап көру"},
    ("I", 6): {"frame": "Бақылау жұмысының алдында алдымен байыппен ойлануға, немесе бірден қол көтеріп, бірінші жауап беруге болады.",
               "option_a_text": "Алдымен ойлау", "option_b_text": "Бірінші жауап беру"},
    ("A", 1): {"frame": "Сурет сабағында өзіңше ерекше нәрсе ойлап табуға, немесе қарындаштарды үйретілгендей түсіне қарай реттеуге болады.",
               "option_a_text": "Ерекше нәрсе ойлап табу", "option_b_text": "Орын-орнына қою"},
    ("A", 2): {"frame": "Өз әңгімеңді шығаруға, немесе мәтінді бір қатесіз ұқыпты көшіріп жазуға болады.",
               "option_a_text": "Әңгіме шығару", "option_b_text": "Ұқыпты болу"},
    ("A", 3): {"frame": "Математикада мысалды ерекше жолмен есептеуге, немесе оны үлгі бойынша дәл шығаруға болады.",
               "option_a_text": "Өзімше шешу", "option_b_text": "Үлгімен есептеу"},
    ("A", 4): {"frame": "Қолөнерді жұрттыкіндей емес жасауға, немесе оны нұсқаулық бойынша қатаң жасауға болады.",
               "option_a_text": "Жұрттай емес жасау", "option_b_text": "Нұсқаулықпен жасау"},
    ("A", 5): {"frame": "Музыка сабағында өз әуеніңді ойлап табуға, немесе берілген пьесаны аяғына дейін ойнап шығуға болады.",
               "option_a_text": "Әуен ойлап табу", "option_b_text": "Аяғына дейін ойнау"},
    ("A", 6): {"frame": "Бүкіл сабақ бойы қалағаныңды салуға, немесе сабақ ішінде тапсырылғанның бәрін үлгеруге болады.",
               "option_a_text": "Қалағанын салу", "option_b_text": "Бәрін үлгеру"},
    ("A", 7): {"frame": "Мектеп мерекесінде жарқын әрі көзге түсіп өнер көрсетуге, немесе конкурс ережелерін дәл сақтауға болады.",
               "option_a_text": "Жарқын өнер көрсету", "option_b_text": "Ереже бойынша ойнау"},
}
_JUNIOR_RIASEC_CONTENT = _merge_bilingual(_JUNIOR_RIASEC_CONTENT, _KK_JUNIOR_RIASEC_CONTENT)
...
_KK_JUNIOR_BIGFIVE_CONTENT: dict[tuple, dict[str, str]] = {
    ("N", 1): {"frame": "Үйде тыныш әрі жайлы, ал аулада музыкамен шулы мереке жүріп жатыр.",
               "option_a_text": "Тыныш жерде қалу", "option_b_text": "Шулы мерекеге бару"},
    ("E", 1): {"frame": "Жаңа үйірмеде бірден барып балалармен танысуға, немесе қабырғадағы әдемі суреттерді қарауға болады.",
               "option_a_text": "Балалармен танысу", "option_b_text": "Суреттерді қарау"},
    ("O", 1): {"frame": "Сурет ойлағандай шықпай жатыр.",
               "option_a_text": "Жаңа нәрсе ойлап табу", "option_b_text": "Ашуланып, тастап кету"},
    ("A", 1): {"frame": "Досың дәл қазір күрделі тапсырманы шешуге көмектесуді сұрап тұр, ал бөлмені әлдеқашан жинау керек — бәріне бірдей уақыт жетпейді.",
               "option_a_text": "Досқа тапсырмамен көмектесу", "option_b_text": "Бөлмені жинау"},
    ("C", 1): {"frame": "Командада жобаның күрделі бөлігі қалды, ал жеңілі дайын болып қалды.",
               "option_a_text": "Күрделі бөлікті алып, аяғына жеткізу", "option_b_text": "Жеңіл бөлікке қосылу"},
    ("N", 3): {"frame": "Бақылау жұмысындағы сәтсіздіктен кейін жалғыз тыныш отырып, есін жиюға, немесе жаңа іспен алаңдау үшін бірден үйірмеге баруға болады.",
               "option_a_text": "Жалғыз болу", "option_b_text": "Жаңа іспен алаңдау"},
    ("E", 3): {"frame": "Аулаға топ жиналды: біреулері ойынға рөл бөліп жатыр, енді біреулері әзілдеп итісіп, ойнақтап жүр.",
               "option_a_text": "Басты рөлді алу", "option_b_text": "Ойнақтауға қосылу"},
    ("O", 3): {"frame": "Мұңды фильмді көріп болдың, оның соңы естен кетпей тұр — бірақ үй тапсырмасын кешке дейін бітіру керек.",
               "option_a_text": "Фильм туралы әлі мұңаю", "option_b_text": "Бірден үй тапсырмасына кірісу"},
    ("A", 3): {"frame": "Сыныпқа жаңа келген бала үзілісте жалғыз тұр.",
               "option_a_text": "Барып, үйренісуге көмектесу", "option_b_text": "Жанынан өте шығу"},
    ("C", 3): {"frame": "Досыңа сабақтан кейін көмектесуге уәде берген едің, ал енді басқа да көп шаруа жиналып қалды.",
               "option_a_text": "Досқа берген уәдеде тұру", "option_b_text": "Барлық іске бірден кірісу"},
    ("N", 5): {"frame": "Туған күнде сондай көңілді, кету керек болса да, тоқтағың келмейді.",
               "option_a_text": "Уақытты ұмытып, көңіл көтере беру", "option_b_text": "Уақытында тоқтап, қоштасу"},
    ("E", 5): {"frame": "Лагерьде шытырман элементтері бар жорыққа жазылуға, немесе түрлі елдердегі өмір туралы айтатын саяхатшымен кездесуге баруға болады.",
               "option_a_text": "Шытырман жорыққа бару", "option_b_text": "Саяхатшымен кездесу"},
    ("O", 5): {"frame": "Күрделі, бірақ қызық кітаппен енді ғана жайғасып едің — досың жазып тұр: көңіл күйі онша емес, әңгімелесуге шақырады.",
               "option_a_text": "Кітапты оқып бітіру", "option_b_text": "Доспен әңгімелесу"},
    ("A", 5): {"frame": "Жарыста жеңіп шықтың.",
               "option_a_text": "Бәрінен мықты болдым деу", "option_b_text": "Бәрі жарайды деу"},
    ("C", 5): {"frame": "Күнделікті жоспар кенеттен өзгерді.",
               "option_a_text": "Жаңа жоспарды тез құру", "option_b_text": "Бәрін жүріп-тұра істеу"},
}
_JUNIOR_BIGFIVE_CONTENT = _merge_bilingual(_JUNIOR_BIGFIVE_CONTENT, _KK_JUNIOR_BIGFIVE_CONTENT)
...
_KK_MIDDLE_RIASEC_CONTENT: dict[tuple, dict[str, str]] = {
    ("R", 1): {"frame": "Көрші велосипедті жөндеуге көмектесуді сұрайды, ал досың сол кезде аулада серуендеуге шақырады.",
               "option_a_text": "Велосипедті жөндеу", "option_b_text": "Досыңмен серуендеу"},
    ("R", 2): {"frame": "Сенбілікте қоршауды жөндеуге жазылуға немесе жұмыстан кейін бәріне арналған шай ішуді ұйымдастыруға болады.",
               "option_a_text": "Қоршауды жөндеу", "option_b_text": "Шай ішуді ұйымдастыру"},
    ("R", 3): {"frame": "Лагерьде бір топ орманда күрке салуға барады, екіншісі — алаңда командалық ойын ойнауға.",
               "option_a_text": "Күрке салу", "option_b_text": "Командамен ойнау"},
    ("R", 4): {"frame": "Демалыс күні үйде ескі компьютерді бөлшектеуге немесе әлдеқашан шақырып жүрген сыныптасыңа қонаққа баруға болады.",
               "option_a_text": "Компьютерді бөлшектеу", "option_b_text": "Қонаққа бару"},
    ("R", 5): {"frame": "Үзілісте мұғалім компьютермен жұмыс істеуге көмектесуді сұрайды, ал сыныпқа жаңа келген бала ешкіммен таныса алмай тұр.",
               "option_a_text": "Мұғалімге компьютермен көмектесу", "option_b_text": "Жаңа балаға үйренісуге көмектесу"},
    ("R", 6): {"frame": "Демалыс күні үй шаруасына көмектесуге, немесе отбасыңмен туыстарға қонаққа баруға болады.",
               "option_a_text": "Үй шаруасына көмектесу", "option_b_text": "Қонаққа бару"},
    ("I", 1): {"frame": "Ғылыми клубқа қабылдап жатыр: біреулері күрделі есепті өздері шешеді, енді біреулері мектепке презентация дайындайды.",
               "option_a_text": "Есепті шешу", "option_b_text": "Презентация дайындау"},
    ("I", 2): {"frame": "Жобада тақырыпты өзің терең зерттеуге немесе сынып алдында сөз сөйлеуді мойныңа алуға болады.",
               "option_a_text": "Тақырыпты зерттеу", "option_b_text": "Сынып алдында сөйлеу"},
    ("I", 3): {"frame": "Мектеп олимпиадасында командада ең күрделі есепті мойныңа алуға, немесе капитан болып, бүкіл команданы бастауға болады.",
               "option_a_text": "Күрделі есеп шешу", "option_b_text": "Команда капитаны болу"},
    ("I", 4): {"frame": "Робототехника үйірмесінде: біреуі роботтың бағдарламасын түсінеді, екіншісі роботты қазылар алқасына таныстырады.",
               "option_a_text": "Бағдарламаны түсіну", "option_b_text": "Қазыларға таныстыру"},
    ("I", 5): {"frame": "Үзілісте досыңмен жұмбақтың қалай құрылғаны туралы айтысып бітіруге, немесе өзің ойлап тапқан ойынға сыныпты жинауға болады.",
               "option_a_text": "Жұмбақты түсіну", "option_b_text": "Сыныпты ойынға жинау"},
    ("I", 6): {"frame": "Конкурста командада деректерді талдауды мойныңа алуға, немесе бірден өз батыл идеяңды ұсынуға болады.",
               "option_a_text": "Деректерді талдау", "option_b_text": "Батыл идея ұсыну"},
    ("A", 1): {"frame": "Технология сабағында өзің ерекше нәрсе ойлап табуға немесе қолөнерді нұсқаулық бойынша ұқыпты жасауға болады.",
               "option_a_text": "Ерекше нәрсе ойлап табу", "option_b_text": "Нұсқаулықпен жасау"},
    ("A", 2): {"frame": "Сынып бұрышын дайындап жатырсыңдар: біреуі жарқын плакатты қолмен салады, екіншісі бәрін нақты жоспармен орналастырады.",
               "option_a_text": "Плакат салу", "option_b_text": "Жоспармен орналастыру"},
    ("A", 3): {"frame": "Сабақтан кейін өз суретіңді салып бітіруге, немесе тарих бойынша конспектіні таза көшіріп жазуға болады.",
               "option_a_text": "Суретті салып бітіру", "option_b_text": "Конспектіні таза көшіру"},
    ("A", 4): {"frame": "Баяндаманы ерекше, өзіңше безендіруге, немесе мұғалім берген үлгі бойынша жасауға болады.",
               "option_a_text": "Өзімше безендіру", "option_b_text": "Үлгімен жасау"},
    ("A", 5): {"frame": "Үйірмеде ережесіз өз әңгімеңді шығаруға, немесе сөз сөйлеудің толық жоспарын тармақтап құруға болады.",
               "option_a_text": "Әңгіме шығару", "option_b_text": "Жоспарды тармақтап құру"},
    ("A", 6): {"frame": "Бос күні ойға оралғанды салуға, немесе аптаға арналған нақты жоспар құруға болады.",
               "option_a_text": "Сурет салу", "option_b_text": "Аптаға жоспар құру"},
}
_MIDDLE_RIASEC_CONTENT = _merge_bilingual(_MIDDLE_RIASEC_CONTENT, _KK_MIDDLE_RIASEC_CONTENT)
...
_KK_MIDDLE_BIGFIVE_CONTENT: dict[tuple, dict[str, str]] = {
    ("N", 1): {"frame": "Ертең бақылау жұмысы, ал кешке достар шулы топқа шақырып тұр.",
               "option_a_text": "Үйде қалып, дайындалу", "option_b_text": "Достарға барып, көңіл көтеру"},
    ("E", 1): {"frame": "Жаңа мектепке ауыстың. Үзілісте тек бір нәрсеге ғана уақыт бар.",
               "option_a_text": "Барып, жаңа балалармен танысу", "option_b_text": "Мұнда не қызық екенін бақылау"},
    ("O", 1): {"frame": "Сурет сабағында бір керемет нәрсе ойлап табуға, немесе сурет керегінше шықпай ма деп уайымдауға болады.",
               "option_a_text": "Керемет нәрсе ойлап табу", "option_b_text": "Сурет үшін уайымдау"},
    ("A", 1): {"frame": "Досыңның сүйікті заты сынып қалды, ал сенің бітпеген үй тапсырмаң бар — тек біреуіне уақыт бар.",
               "option_a_text": "Досқа көмектесу", "option_b_text": "Тапсырманы бітіру"},
    ("C", 1): {"frame": "Сенбілікте бастаған істі аяғына жеткізуге немесе қиналып жатқанға бірден көмектесуге баруға болады.",
               "option_a_text": "Өз ісін аяғына жеткізу", "option_b_text": "Қиналғанға көмектесу"},
    ("N", 3): {"frame": "Қиын емтиханның алдында үйренгеннің бәрін тағы бір рет тексеруге, немесе тақырыпты басқа қырынан түсінуге тырысуға болады.",
               "option_a_text": "Бәрін қайта тексеру", "option_b_text": "Жаңаша қарау"},
    ("E", 3): {"frame": "Мұғалім топқа маңызды тапсырма берді.",
               "option_a_text": "Жетекші рөлін алу", "option_b_text": "Ең күрделі бөлікті бәрінен жақсы істеу"},
    ("O", 3): {"frame": "Әдебиет сабағында әңгіменің аяқталуының өз нұсқасын ойлап табуға, немесе басты кейіпкердің не сезінгенін егжей-тегжейлі жазуға болады.",
               "option_a_text": "Басқа соңын ойлап табу", "option_b_text": "Кейіпкердің сезімін жазу"},
    ("A", 3): {"frame": "Сыныптасыңның ойында бірдеңесі шықпай жатыр, бәрі оған қарап тұр.",
               "option_a_text": "Бәрінің көзінше демеу беру", "option_b_text": "Шетке шығу"},
    ("C", 3): {"frame": "Сабақтан кейін рюкзак пен жазбаларды байыппен реттеуге немесе аулаға шулы топқа жүгіруге болады.",
               "option_a_text": "Рюкзакты реттеу", "option_b_text": "Достарға жүгіру"},
    ("N", 5): {"frame": "Кешке үйде тыныш, ал далада достар шулы оқиғаларға шақырады.",
               "option_a_text": "Тыныш үйде қалу", "option_b_text": "Оқиға іздеп кету"},
    ("E", 5): {"frame": "Демалыстағы бос кеш — көңілді әрі көп жаңа таныс болатын жерге баруға, немесе оқыған сайын қызықтыра түсетін кітаппен үйде қалуға болады.",
               "option_a_text": "Көңілді жерге бару", "option_b_text": "Кітаппен қалу"},
    ("O", 5): {"frame": "Топтық жобада сенде ерекше идея бар, ал сыныптасың сенімен бірге үлгеру үшін жеңілірек нәрсе таңдауды сұрайды.",
               "option_a_text": "Өз идеяңды ұсыну", "option_b_text": "Жолдас үшін жеңілін таңдау"},
    ("A", 5): {"frame": "Досыңның есебі шықпай жатыр, ал сенің өзіңнің бұрыннан бітпеген ісің бар.",
               "option_a_text": "Досқа көмектесу", "option_b_text": "Өз ісін бітіру"},
    ("C", 5): {"frame": "Демалысқа арналған жоспар кенеттен өзгерді.",
               "option_a_text": "Жаңа нақты жоспарды тез құру", "option_b_text": "Шешім қабылдамас бұрын сәл абдырау"},
}
_MIDDLE_BIGFIVE_CONTENT = _merge_bilingual(_MIDDLE_BIGFIVE_CONTENT, _KK_MIDDLE_BIGFIVE_CONTENT)
