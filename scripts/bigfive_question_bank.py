...
QUESTIONS: list[dict] = [
    ...
    {"bigfive_domain": "O", "facet": 3, "keyed": "plus", "text": "Сильно эмоционален"},
    ...
    {"bigfive_domain": "E", "facet": 4, "keyed": "plus", "text": "Всегда занят"},
    ...
    {"bigfive_domain": "N", "facet": 5, "keyed": "plus", "text": "Могу чрезмерно увлечься"},
    ...
    {"bigfive_domain": "C", "facet": 5, "keyed": "plus", "text": "Всегда готов"},
    ...
    {"bigfive_domain": "O", "facet": 1, "keyed": "plus", "text": "Наслаждаюсь необузданными полетами фантазии"},
    {"bigfive_domain": "A", "facet": 1, "keyed": "plus", "text": "Верю в хорошие намерения людей"},
    {"bigfive_domain": "C", "facet": 1, "keyed": "plus", "text": "Превосходен в своем деле"},
    ...
    {"bigfive_domain": "N", "facet": 3, "keyed": "plus", "text": "Часто бываю недоволен собой"},
    ...
    {"bigfive_domain": "N", "facet": 6, "keyed": "plus", "text": "Легко подавляем событиями"},
    ...
    {"bigfive_domain": "O", "facet": 1, "keyed": "plus", "text": "Люблю помечтать"},
    {"bigfive_domain": "A", "facet": 1, "keyed": "plus", "text": "Доверяю тому, что люди говорят мне"},
    {"bigfive_domain": "C", "facet": 1, "keyed": "plus", "text": "Справлюсь с задачами без проблем"},
    {"bigfive_domain": "N", "facet": 2, "keyed": "plus", "text": "Легко теряю самообладание"},
    {"bigfive_domain": "E", "facet": 2, "keyed": "minus", "text": "Предпочитаю быть одному"},
    ...
    {"bigfive_domain": "E", "facet": 3, "keyed": "plus", "text": "Беру контроль"},
    {"bigfive_domain": "O", "facet": 3, "keyed": "minus", "text": "Редко замечаю свои эмоциальные реакции"},
    {"bigfive_domain": "A", "facet": 3, "keyed": "minus", "text": "Безразличен к чувствам других"},
    ...
    {"bigfive_domain": "E", "facet": 5, "keyed": "plus", "text": "Наслаждаюсь опрометчивостью"},
    ...
    {"bigfive_domain": "C", "facet": 6, "keyed": "minus", "text": "Поспешно начинаю дела не обдумав"},
    ...
    {"bigfive_domain": "O", "facet": 1, "keyed": "plus", "text": "Люблю потеряться в мыслях"},
    ...
    {"bigfive_domain": "E", "facet": 2, "keyed": "minus", "text": "Избегаю толпу"},
    ...
    {"bigfive_domain": "N", "facet": 3, "keyed": "minus", "text": "Чувствую себя комфортно с самим собой"},
    ...
    {"bigfive_domain": "E", "facet": 4, "keyed": "minus", "text": "Люблю ничего не принимать близко к сердцу"},
    ...
    {"bigfive_domain": "N", "facet": 5, "keyed": "minus", "text": "Способен контролировать свои желания"},
    {"bigfive_domain": "E", "facet": 5, "keyed": "plus", "text": "Веду себя дико и безумно"},
    {"bigfive_domain": "O", "facet": 5, "keyed": "minus", "text": "Не заинтересован в теоретических рассуждениях"},
    ...
    {"bigfive_domain": "O", "facet": 6, "keyed": "minus", "text": "Уверен, что есть только один правильный взгляд на вещи, и я его придерживаюсь"},
    {"bigfive_domain": "A", "facet": 6, "keyed": "minus", "text": "Стараюсь не думать о нуждающихся"},
    {"bigfive_domain": "C", "facet": 6, "keyed": "minus", "text": "Действую необдуманно"},
]
