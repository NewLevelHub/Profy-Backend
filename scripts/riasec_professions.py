...
PROFESSIONS: list[dict] = [
    # Realistic
    {"section": "Realistic", "title": "Инженер-механик", "holland_code": "RIS", "category_slugs": ["mechanical-industrial-engineering"]},
    {"section": "Realistic", "title": "Пилот гражданской авиации", "holland_code": "RIE", "category_slugs": ["transport-aviation-engineering"]},
    {"section": "Realistic", "title": "Авиадиспетчер", "holland_code": "SER", "category_slugs": ["transport-aviation-engineering"]},
    {"section": "Realistic", "title": "Геодезист", "holland_code": "IRE", "category_slugs": ["construction-architecture"]},
    {"section": "Realistic", "title": "Инженер-строитель", "holland_code": "RIE", "category_slugs": ["construction-architecture"]},
    {"section": "Realistic", "title": "Инженер-электрик", "holland_code": "REI", "category_slugs": ["electrical-power-engineering"]},
    ...
    {"section": "Realistic", "title": "Буровой инженер (нефтегазовое дело)", "holland_code": "RIE", "category_slugs": ["oil-gas-mining-geology"]},
    {"section": "Realistic", "title": "Машинист локомотива", "holland_code": "RES", "category_slugs": ["transport-aviation-engineering"]},
    {"section": "Realistic", "title": "Технолог пищевого производства", "holland_code": "RCI", "category_slugs": ["production-technology"]},
    ...
    {"section": "Investigative", "title": "Геолог", "holland_code": "IRE", "category_slugs": ["oil-gas-mining-geology"]},
    {"section": "Investigative", "title": "Биолог", "holland_code": "IRE", "category_slugs": ["biology-ecology"]},
    {"section": "Investigative", "title": "Химик", "holland_code": "IRE", "category_slugs": ["natural-sciences-research"]},
    ...
    {"section": "Investigative", "title": "Математик", "holland_code": "IRE", "category_slugs": ["natural-sciences-research"]},
    {"section": "Investigative", "title": "Археолог", "holland_code": "IRE", "category_slugs": ["natural-sciences-research"]},
    {"section": "Investigative", "title": "Метеоролог", "holland_code": "IRS", "category_slugs": ["natural-sciences-research"]},
    ...
    # Artistic
    {"section": "Artistic", "title": "Архитектор", "holland_code": "AIR", "category_slugs": ["construction-architecture", "design-digital-art"]},
    {"section": "Artistic", "title": "Графический дизайнер", "holland_code": "AES", "category_slugs": ["design-digital-art"]},
    {"section": "Artistic", "title": "Модельер", "holland_code": "ASR", "category_slugs": ["design-digital-art", "production-technology"]},
    ...
    {"section": "Conventional", "title": "Специалист по стандартизации и сертификации", "holland_code": "CES", "category_slugs": ["production-technology"]},
