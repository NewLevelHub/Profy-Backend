...
KK_NAMES: dict[str, str] = {
    ...
    "Управляющий фермерским хозяйством": "Фермер шаруашылығының басқарушысы",
    ...
    "Технический писатель": "Техникалық құжаттама маманы",
    ...
    "Воспитатель детского сада": "Балабақша тәрбиешісі",
    "HR-менеджер": "HR-менеджер",
    "Тренер по спорту": "Спорт жаттықтырушысы",
    "Гид-экскурсовод": "Гид-экскурсовод",
    ...
    "Директор по маркетингу": "Маркетинг директоры",
    ...
    "Секретарь-делопроизводитель": "Хатшы-іс жүргізуші",
    "Специалист технической поддержки": "Техникалық қолдау маманы",
    "Кредитный аналитик": "Несие талдаушысы",
    "Специалист по кадровому делопроизводству": "Кадрлық іс жүргізу маманы",
    "Архивариус": "Мұрағатшы",
