...
async def main() -> None:
    ...
    async with async_session() as db:
        ...
        for entry in reviewed:
            ...
            direction.description = entry["description"]
            direction.skills_needed = entry["skills_needed"]
            direction.subjects_to_develop = entry["subjects_to_develop"]
            direction.first_steps = entry["first_steps"]
            updated += 1
