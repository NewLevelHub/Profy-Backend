...
LABILITY_ITEMS: list[dict] = [
    ...
    {"instruction": "Первая буква вашего имени (не фамилии) — гласная? Выберите «Да» или «Нет».",
...
_KK_LABILITY: list[dict] = [
    ...
    {"instruction": "Есіміңіздің (тегіңіздің емес) бірінші әрпі дауысты дыбыс па? «Иә» немесе «Жоқ» деп таңдаңыз.", "options": ["иә", "жоқ"]},
...
_KK_GENERALIZATION: list[dict] = [
    ...
    {"pair": ("Кескіндеме", "мүсін өнері"), "score_2": ["бейнелеу өнері"], "score_1": ["өнер", "шығармашылық", "мәдениет", "өнер түрлері"]},
    {"pair": ("Африка", "Антарктида"), "score_2": ["әлем бөліктері", "материктер", "материк", "құрлық", "құрлықтар"], "score_1": ["географиялық объектілер"]},
